...
<section class="fordesigners-media">
    <div class="wrapper">
        <h2 class="fordesigners-media__title">Wellige участвует</h2>
        <div class="media-section">                
            ...
            <div class="media-item--main cf" id="<?=$this->GetEditAreaId($arResult["MAIN_ARTICLE"]['ID']);?>">   
                ...
                <div class="media-item__body">
                    <?if ($arResult["MAIN_ARTICLE"]["PROPERTIES"]["CATEGORY"]["VALUE"]){?>
                        <div class="media-item__source"><?=$arResult["MAIN_ARTICLE"]["PROPERTIES"]["CATEGORY"]["VALUE"]?></div> 
                        <?}?>
                ...
                <?foreach ($arResult["ITEMS"] as $arItem) {?>
                    ...
                    <div class="media-item" id="<?=$this->GetEditAreaId($arItem['ID']);?>">
                        ...
                        <div class="media-item__body">
                            ...
                            <a href="<?=$arItem["DETAIL_PAGE_URL"]?>" class="media-item__btn btn btn--greenbg">посмотреть полностью</a> 
                        </div>
                    </div>   
                    <?}?>    
            </div>
...
<div class="fordesigners-more">
    <div class="wrapper">
        <a href="/media/"><div class="btn btn--greenbg">ещё о wellige в медиа</div></a>
        <a href="/"><div class="btn btn--greenbg">о бренде</div></a>
    </div>
</div>
