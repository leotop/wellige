...
<section class="request request--franchise">
    <div class="wrapper contacts-page">
        <h2 class="request__title">вопросы или предложения?</h2>
        <div class="request__form">
            <form class="js-submit-form" method="GET" action="<?=$templateFolder."/ajax/action.php"?>">
                <div class="request__field input-field">
                    <label for="name">Ваше имя</label>
                <input type="text" id="NAME" name="NAME" autocomplete="off"> </div>
                <div class="request__field input-field">
                    <label for="mail">Электронная почта (для ответа)</label>
                <input type="email" id="EMAIL" name="EMAIL" autocomplete="off"> </div>
                ...
                <!--form type ID-->
                <input type="hidden" id="TYPE" name="TYPE" value="27">
                <!--//form type ID-->                      
